...
import { FOOTER_DETAILS } from "@/lib/site-content";
  ...
  return (
    <>
      ...
      <main id="main-content" className="flex-1 flex items-center justify-center py-band-anchor">
        <div className="mx-auto px-md text-center max-w-[42ch]">
          <p className="font-body text-small font-medium uppercase tracking-wide text-muted-foreground mb-sm">
            404 — Not Found
          </p>
          <h1 className="font-heading text-h1 text-foreground mb-md">
